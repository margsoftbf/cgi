...
import slide1Image from '../assets/A1.png';
import slide2Image from '../assets/K1.png';
			...
			<div className='max-w-wrapper mx-auto'>
				<div className='flex flex-col lg:flex-row justify-center'>
					<div className='relative w-full xl:w-1/2 lg:w-full px-8 ml-2 sm:ml-32 lg:ml-2'>
						<div className='absolute left-0 top-0 h-56 w-4 bg-third rounded-t-full rounded-b-full'></div>
					...
					<div className='w-full xl:w-1/2 lg:w-full px-4 flex flex-col justify-center gap-3 mt-20 lg:mt-0'>
						<div className='mb-4'>
							...
							<p className='text-2xl text-left text-third font-teko font-light uppercase'>
								Od 2002 roku świadczymy usługi dla ponad 100 firm, realizując
								670 projektów.
							</p>
						</div>

						<p className='text-four text-left mb-4'>
